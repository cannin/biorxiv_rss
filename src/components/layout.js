      ...
      <>
        ...
        >
          ...
          <footer name="footer">
            ...
            Copyright: {new Date().getFullYear()}. Built with {` `} <a onClick={() => onLinkClick('rss')} href="https://www.gatsbyjs.org">Gatsby</a> and <a href="https://rxivist.org">Rxivist</a>. <a href="rss.xml"><FaRssSquare /> RSS Feed</a>. <br/>
          </footer>
        </div>
      </>
    )}
